...
"""
  ...
  <div class="flex flex-col p-6 bg-white dark:bg-zinc-800 rounded-xl shadow border border-zinc-200 dark:border-zinc-700 w-full hover:-translate-y-1 transition duration-200">
    ...
    <div class="flex flex-col gap-3 mt-auto">
        <a href="{url}" target="_blank" rel="noopener" class="flex h-12 items-center justify-center text-center px-4 bg-zinc-100 dark:bg-zinc-700 hover:bg-zinc-200 dark:hover:bg-zinc-600 text-zinc-800 dark:text-zinc-100 rounded-lg transition font-bold whitespace-nowrap">Website</a>
        <a href="{gl_project}" target="_blank" rel="noopener" class="flex h-12 items-center justify-center text-center px-4 bg-primary-100 dark:bg-primary-900/60 hover:bg-primary-200 dark:hover:bg-primary-800 text-primary-800 dark:text-primary-100 rounded-lg transition border border-primary-200 dark:border-primary-700 font-bold whitespace-nowrap">GitLab Project</a>
        <a href="{gl_issue}" target="_blank" rel="noopener" class="flex h-12 items-center justify-center text-center px-4 bg-red-100 dark:bg-red-900/40 hover:bg-red-200 dark:hover:bg-red-800 text-red-800 dark:text-red-200 rounded-lg transition border border-red-200 dark:border-red-900 font-bold whitespace-nowrap">Create Incident</a>
    </div>
  </div>"""
    content += "\n</div>\n"
...
if __name__ == '__main__':
    generate_services()
    generate_issues()
    print("Regenerated correctly without empty lines and vertical buttons.")
